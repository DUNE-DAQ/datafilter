...
main(int argc, char* argv[])
{
  ...
  int result = dunedaq::datafilter::parseCommandLine(argc, argv, args, "TR Dispatcher");

  if (result != 2)
    return result;

  data_t trdispatcher_cfg = { { "app_name", args.appName }, { "sessionName", args.sessionName } };
  ...
  std::shared_ptr<dunedaq::appfwk::DAQModule> trdispatcher1 = make_module("TRDispatcher", "TRDispatcher_0");
