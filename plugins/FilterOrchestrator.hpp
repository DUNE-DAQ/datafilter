...
#ifndef DATAFILTER_PLUGINS_FILTERORCHESTRATOR_HPP_
#define DATAFILTER_PLUGINS_FILTERORCHESTRATOR_HPP_
...
private:
  ...
  // FilterOrchestrator.cpp you would implement do_conf so that members of
  // FilterOrchestrator get assigned values from a configuration passed as 
  ...
  // called. "amount" represents a (discrete) value which changes as FilterOrchestrator
...
#endif // DATAFILTER_PLUGINS_FILTERORCHESTRATOR_HPP_
